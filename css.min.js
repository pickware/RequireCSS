 ...
 */
(function(){function e(b){var c=a.createElement("link");return c.rel="stylesheet",c.type="text/css",c.href=b,c}function f(b){var c;d.href=b;for(c in a.styleSheets)if(a.styleSheets[c].href===d.href)return!0;return!1}function g(a,b){c?h(a,b):i(a,b)}function h(a,c){var d=e(a);d.onload=function(){c()},b.appendChild(d)}function i(c,d){var g=e(c),h=a.createElement("script");b.appendChild(g),h.onload=h.onerror=function(){b.removeChild(h);var a=function(){if(f(c)){d();return}setTimeout(a,25)};a()},h.src=c,b.appendChild(h)}"use strict";var a=document,b=a.head||a.getElementsByTagName("head")[0],c=a.createElement("link").onload===null?undefined:!1,d=a.createElement("a");define(function(){var a;return a={version:"0.3.1",load:function(a,d,f){var h=d.toUrl(a.search(/\.(css|less|scss)$/i)===-1?a+".css":a);if(c===undefined){var i=e("data:text/css,");i.onload=function(){c=!0},b.appendChild(i),setTimeout(function(){b.removeChild(i),c!==!0&&(c=!1),g(h,f)},0)}else g(h,f)}},a})})()